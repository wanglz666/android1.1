...
import com.example.myapplication.base.component.toast.config.IToastInterceptor;
import com.example.myapplication.base.component.toast.config.IToastStrategy;
import com.example.myapplication.base.component.toast.config.IToastStyle;
import com.example.myapplication.base.component.toast.style.BlackToastStyle;
import com.example.myapplication.base.component.toast.style.CustomToastStyle;
import com.example.myapplication.base.component.toast.style.LocationToastStyle;
import com.example.myapplication.base.component.toast.style.WhiteToastStyle;
...
public final class BaseToast {
    ...
    /**
     * 检查框架初始化状态，如果未初始化请先调用{@link BaseToast#init(Application)}
     */
